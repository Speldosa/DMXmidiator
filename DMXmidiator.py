                                ...
                                if(Layer2.Program[0][1] == 0): # Sub program 0.
                                    for Count in range(len(Layer1.Array_of_Layer1_objects)):
                                        ...
                                        Layer1.Array_of_Layer1_objects[Count] = Layer1_light_object(
                                            ...
                                            Hue = Signal(ADSR(After_attack_amplitude=CC_to_ratio(Layer2.Parameters[0][0]), After_decay_amplitude=CC_to_ratio(Layer2.Parameters[0][0]), Attack=Tmp, Decay=0, Sustain=1, Release=0), LFO()),
                                            Saturation = Signal(ADSR(After_attack_amplitude=0, After_decay_amplitude=1, Attack=Tmp, Decay=0, Sustain=1, Release=0), LFO()),
                                            Brightness = Signal(ADSR(After_attack_amplitude=0, After_decay_amplitude=0.5, Attack=Tmp, Decay=0, Sustain=1, Release=0), LFO(Waveform = "Sine", Amplitude = 1, Repeat = True, Rate = CC_to_ratio(Layer2.Parameters[3][0]), Phase = -0.25 - Tmp))
